...
pub enum SpaceRequest {
    ...
    LeaveSpace { space_name_id: RoomNameId },
    ...
    GetTopLevelSpaceDetails { space_id: OwnedRoomId },
}
...
pub async fn space_service_loop(client: Client) -> anyhow::Result<()> {
    ...
    let (initial_spaces, mut spaces_diff_stream) =
    ...
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            ...
            SpaceRoomListAction::DetailedChildren {
                ...
                .debug_struct("SpaceRoomListAction::DetailedChildren")
                .field("space_id", space_id)
                .field("parent_chain", &parent_chain)
                .field("num_children", &children.len())
                .finish(),
            SpaceRoomListAction::TopLevelSpaceDetails(space) => f
                .debug_tuple("SpaceRoomListAction::TopLevelSpaceDetails")
                .field(space)
                .finish(),
            SpaceRoomListAction::LeaveSpaceResult {
                ...
                .debug_struct("SpaceRoomListAction::LeaveSpaceResult")
