use crate::{
    ...
    home::{
        ...
        rooms_list::{
            self, enqueue_rooms_list_update, RoomPreviewAvatar, RoomsListEntry, RoomsListUpdate,
        },
    },
    ...
    shared::{jump_to_bottom_button::UnreadMessageCount, popup_list::enqueue_popup_notification},
...
use matrix_sdk::{
    ...
    Client, ClientBuildError, Error, Room, RoomMemberships,
};
use matrix_sdk_ui::{
    room_list_service::{self, RoomListLoadingState},
    sync_service::{self, SyncService},
    timeline::{
        AnyOtherFullStateEventContent, EventTimelineItem, MembershipChange, RepliedToInfo,
        ...
        _ => {
            if let Ok(room_members) = room.members(RoomMemberships::ACTIVE).await {
                if room_members.len() == 2 {
                    ...
                    {
                        return match non_account_member
