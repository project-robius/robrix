...
impl DeleteBotModal {
    fn handle_actions(&mut self, cx: &mut Cx, actions: &Actions) {
        ...
        let delete_button = self.view.button(cx, ids!(card.buttons.delete_button));
        let user_id_input = self.view.text_input(cx, ids!(card.form.user_id_input));
    ...
    pub fn show(&mut self, cx: &mut Cx, room_name_id: RoomNameId) {
        ...
        self.view.label(cx, ids!(card.title)).set_text(cx, "Delete Room Bot");
        ...
        self.view
            .text_input(cx, ids!(card.form.user_id_input))
            .set_text(cx, "");
        self.view.label(cx, ids!(card.status_label)).set_text(cx, "");
        self.view
            .button(cx, ids!(card.buttons.delete_button))
            .set_enabled(cx, true);
        self.view
